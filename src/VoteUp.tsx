...
{  
    ...
    voteDown(e: any) {
        const onVoteDown = this.getAttributeValue(this.table.attributes,"onVoteDown","");
	...
	render()
	{
        let currentVotes: number = parseInt(this.props.contentValue);
        return (
            <div
                className="voteup"
            >
                ...
                >
                    <span 
                        className="glyphicon glyphicon-triangle-top voteup-button"
                        title="Vote App Up"
                        onClick={this.voteUp}
                    />
                </div>
                ...
                >
                    <span 
                        className="glyphicon glyphicon-triangle-bottom voteup-button"
                        title="Vote App Down"
